		...
		$mediaKit = [
			...
			'story' => (object)[
				...
				'location' => LocationController::createLocation([
					'name' => $content->selectedCountry,
					'city_flag' => false,
					'state_flag' => false,
					'country_flag' => true,
				]),
				'state' => $content->selectedState ? LocationController::getStateById($content->selectedState) : '',
				'city' => $content->selectedCity ? LocationController::getCityById($content->selectedCity) : '',
				'site_area' => $content->siteArea,
				'siteAreaUnit' => $content->siteAreaUnit ? AreaController::findById($content->siteAreaUnit) : '',
				'built_up_area' => $content->builtUpArea,
				'materials' => $content->materials,
				'builtUpAreaUnit' => $content->builtUpAreaUnit ? AreaController::findById($content->builtUpAreaUnit) : '',
				'buildingUse' => $content->buildingUse ? BuildingUseController::findById($content->buildingUse) : '',
				'image_credits' => $content->imageCredits,
				'text_credits' => $content->textCredits,
				'render_credits' => $content->renderCredits,
