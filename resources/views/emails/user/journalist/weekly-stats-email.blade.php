...
@section('body')
<h2 style="font-size: 30px;">Your Weekly Fublis Stats</h2>
<p class="mb-3">Hi {{ $name }},</p>
<p>We trust you're having a fantastic week! At Fublis, we are committed to providing you with the tools and insights to thrive in your journalistic endeavors. Today, we're excited to share your weekly performance statistics, giving you a glimpse into the impact you're making on our platform.</p>
<hr style="width: 96px; margin: 15px 0; color: #EAECF0; height: 1px;">
<p class="mb-3"><strong>Here's a snapshot of your Fublis journey this week:</strong></p>
<div>
