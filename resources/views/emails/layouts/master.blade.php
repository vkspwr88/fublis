...
<small>
This email was sent to <span class="link">{{ Str::mask($senderEmail, '*', 3, Str::length($senderEmail) - 6) }}</span>. If you'd rather not receive this kind of email, you can <a href="{{ $preferenceUrl ?? '#' }}" class="link">unsubscribe or manage your email preferences</a>.
</small>
</p>
