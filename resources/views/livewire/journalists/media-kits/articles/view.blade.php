		...
		<div class="row align-items-center py-2">
			<div class="col">
				<p class="text-dark fs-6 fw-bold m-0">
					<img class="img-fluid rounded-circle me-2" src="{{ $article->architect->company->profileImage ? Storage::url($article->architect->company->profileImage) : 'https://via.placeholder.com/30x30' }}" alt="..." />
