	...
	<div class="col-md-8">
		...
		<div class="row align-items-center py-2">
			<div class="col">
				<p class="text-dark fs-6 fw-bold m-0">
					<img class="img-fluid rounded-circle me-2" src="{{ $project->architect->company->profileImage ? Storage::url($project->architect->company->profileImage) : 'https://via.placeholder.com/30x30' }}" alt="..." />
		...
		<div class="row justify-content-center pt-2 position-relative" style="z-index: 2;">
			<p class="fs-6 fw-bold col m-0">
				<a href="{{ route('journalist.media-kit.project.view', ['mediaKit' => $project->id]) }}" class="btn btn-primary btn-sm rounded-pill">
