			...
			<div class="row g-3">
				...
				<div class="col-12">
					<div class="row g-2">
						...
						<div class="col">
							<span class="badge rounded-pill text-gray-700 bg-gray-200 text-capitalize">{{ $city->state->country->name }}</span>
							<span class="badge rounded-pill text-gray-700 bg-gray-200 text-capitalize">{{ $city->state->name }}</span>
					...
					<div class="row g-3">
						...
						<div class="col-12">
							<div class="row g-1 align-items-center">
								<div class="col-auto">
									<img src="{{ $journalist->profileImage ? Storage::url($journalist->profileImage->image_path) : 'https://via.placeholder.com/36x36' }}" alt=".." class="img-square img-36 rounded-circle">
								</div>
								<div class="col">
