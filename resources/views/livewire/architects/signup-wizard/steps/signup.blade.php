						...
						<div class="row justify-content-between align-items-center">
							<div class="col-12">
								<div class="p-5 card-body">
									...
									<form class="py-3" wire:submit="signup">
										...
										<div class="gap-3 d-grid">
											<button class="btn btn-primary fs-6 fw-semibold" type="submit">
												Sign up as Brand <x-users.spinners.white-btn wire:target="signup" />
											</button>
									...
									<p class="py-2 m-0 card-text text-secondary fs-6">If you're a media professional - whether a journalist, editor, writer, or in another role -working with a publication, sign up for your free account here:</p>
