<form class="py-3" wire:submit="login">
	...
	<div class="mb-3">
		<div class="row">
			...
			<div class="col text-end">
				<a href="{{ route('forgot') }}" class="text-purple-700 fw-semibold">Forgot Password?</a>
			</div>
		</div>
	</div>
	<div class="d-grid gap-3">
		...
		<a href="{{ route('auth.google.index', ['userType' => 'architect', 'loginType' => 'login']) }}" class="btn btn-white fs-6 fw-semibold" type="button">
