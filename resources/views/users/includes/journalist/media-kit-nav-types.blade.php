<div class="row g-0 mb-4">
	<div class="col">
		<div class="d-grid">
			...
			<label class="btn btn-outline-primary rounded-0 fw-semibold" for="media-kit-outlined">
	...
	<div class="col">
		<div class="d-grid">
			...
			<label class="btn btn-outline-primary rounded-0 fw-semibold" for="brand-outlined">
	...
	<div class="col">
		<div class="d-grid">
			...
			<label class="btn btn-outline-primary rounded-0 fw-semibold" for="submission-outlined">
