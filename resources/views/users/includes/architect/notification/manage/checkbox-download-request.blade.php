<div class="col-12">
	<div class="row g-3 align-items-center">
		<div class="col-auto">
			<img class="img-square rounded-circle" src="{{ $downloadRequest->notifiable->requestedJournalist->journalist->profileImage ? Storage::url($downloadRequest->notifiable->requestedJournalist->journalist->profileImage->image_path) : 'https://via.placeholder.com/48x48' }}" alt="..." />
		</div>
		<div class="col-auto">
