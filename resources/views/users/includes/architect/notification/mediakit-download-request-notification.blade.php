<div class="row g-3 align-items-center">
	<div class="col-auto">
		<img class="img-square rounded-circle img-48" src="{{ $notification->notifiable->requestedJournalist->journalist->profileImage ? Storage::url($notification->notifiable->requestedJournalist->journalist->profileImage->image_path) : 'https://via.placeholder.com/48x48' }}" alt="..." />
	</div>
	<div class="col-auto">
		<p class="m-0 p-0">
