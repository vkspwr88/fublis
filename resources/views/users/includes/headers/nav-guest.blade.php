@php
	...
	// dd($menus);
@endphp
<ul class="navbar-nav me-auto h-100 {{-- d-flex align-items-center --}}">
...
<ul class="navbar-nav ms-auto h-100 {{-- d-flex align-items-center --}}">
	@foreach ($menus->journalists as $item)
		<li class="nav-item">
			...
			<ul class="nav-sub-menu end-0" style="left: auto; width: 35em;">
				<li class="text-center nav-sub-menu-item" style="flex: none; width: 162px; background-color: #f2f2f2;">
					<ul class="nav-sub-menu-item-ul">
						<li class="nav-sub-menu-item-li">
							<a class="sf-with-ul">
						...
						<li class="nav-sub-menu-item-li">
							<a href="{{ route('journalist.signup') }}" class="px-3 btn btn-primary fs-7">
								<small>Sign Up</small>
							</a>
						</li>
						<li class="pt-5 nav-sub-menu-item-li">
							<a class="sf-with-ul">
								<span class="nav-sub-menu-title-text">Already member?</span>
							</a>
						</li>
						<li class="nav-sub-menu-item-li">
							<a href="{{ route('login') }}" class="px-3 btn fs-7" style="background-color: #4f4f4f; color: #fff;">
								<small>Sign In</small>
							</a>
						</li>
					</ul>
	...
	<li class="nav-item ms-2">
		<a class="btn btn-primary hover" href="{{ route('signup') }}">
			<span class="nectar-menu-icon svg-icon">
				<svg style="width: 18px; height: 18px; color: #fff; fill: #fff;" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
