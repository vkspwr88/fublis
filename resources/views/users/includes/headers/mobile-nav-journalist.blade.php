...
<ul id="mobileNav" class="px-5 pt-5 mt-4 list-unstyled">
	{{-- <li class="mb-3">
		<div class="m-0 ms-auto" aria-label="search">
			<livewire:journalists.header.search mobile="true" />
		</div>
	</li> --}}
	...
	@endforeach
	<li class="mb-1">
		<a class="btn btn-toggle align-items-center fs-4 fw-semibold" href="{{ route('journalist.account.profile.message.index') }}">
