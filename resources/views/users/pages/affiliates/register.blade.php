...
<html lang="en">
	...
	<body class="bg-white">
		...
		<section class="px-0 pt-3 pb-5 m-0 w-100">
			<div class="container">
				<h4 class="text-center text-black fs-5 fw-bold m-0 py-2">Join Fublis as an affiliate and start earning with us.</h4>
				<p class="text-center text-black fs-6 fw-normal m-0 py-2">You're just 2 mins away from becoming an affiliate with us.</p>
									...
									<div class="row justify-content-between align-items-center">
										<div class="col-12">
											<div class="px-5 card-body">
												<h5 class="card-title text-dark fs-3 fw-semibold m-0 py-2">Affiliate Registration</h5>
												<p class="card-text text-secondary fs-6 fw-normal m-0 py-2">You must be registered as a journalist with Fublis and add publication (website/ social media page) before applying for Affiliate Program.</p>
												<p class="card-text text-secondary fs-6 fw-normal m-0 py-3">New on Fublis? <a href="{{ route('journalist.signup') }}" class="text-purple-700 fw-semibold">Sign Up</a> / Already Member? <a href="{{ route('journalist.login') }}" class="text-purple-700 fw-semibold">Log in</a></p>
