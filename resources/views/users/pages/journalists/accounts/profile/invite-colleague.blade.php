...
<div class="container py-5">
		...
		<div class="col-12">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="text-purple-600 breadcrumb-item fublis-breadcrumb-item fs-6 fw-medium" aria-current="page">Invite Colleagues</li>
				</ol>
			</nav>
		</div>
	</div>
	...
	<livewire:common.invite-colleague.form sender="journalist" />
</div>
@endsection
