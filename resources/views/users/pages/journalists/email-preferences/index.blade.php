...
<div class="container py-5">
	...
	<div class="pb-5 row">
		<div class="col-md-6">
			...
			<p class="mb-5 text-secondary fs-6">Manage Your Email Preferences. Stay in Control - Choose the Notifications That Matter Most to You.</p>

			<livewire:journalists.email-preferences.index />
		</div>
