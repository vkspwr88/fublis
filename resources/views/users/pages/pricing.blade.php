...
@push('styles')
	<style>
		...
		#planTypeGroup .btn{
			border-color: var(--fublis-white);
			color: var(--fublis-white);
			font-weight: 600;
		}
		#planTypeGroup .btn span, #planTypeGroup > .btn-check:checked + .btn{
			background-color: var(--fublis-white);
			color: var(--fublis-purple-600);
		}
		#planTypeGroup > .btn-check:checked + .btn > span{
			color: var(--fublis-white);
			background-color: var(--fublis-purple-600);
		}
...
@section('body')
		...
		<div class="container">
			<div class="row">
				<div class="py-5 text-center col">
					...
					<div class="mb-4">
						<h2 class="m-0 fw-bold fs-1">Upgrade Your Account for</h2>
						<h2 class="m-0 fw-bold fs-1">Unlimited PR Power</h2>
					</div>
					<div class="mb-4 text-pink-200 fs-6">
						<p class="m-0">Unlock advanced features and take your media outreach to the next level.</p>
						<p class="m-0">Choose a plan that suits your needs and start reaching a wider audience effortlessly.</p>
					</div>
				</div>
			</div>
		</div>
	...
	<livewire:users.pricing.plan2024 />
