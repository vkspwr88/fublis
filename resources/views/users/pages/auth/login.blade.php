						...
						<div class="row justify-content-between align-items-center">
							<div class="col-12">
								<div class="px-5 card-body">
									...
									<p class="py-2 m-0 card-text text-secondary fs-6 fw-normal">Welcome back to Fublis! Your source for uncharted stories and curated submissions</p>
									<livewire:users.auth.login />
									<p class="py-2 m-0 text-center card-text text-secondary fs-6">
										Don't have an account?
										<a href="{{ route('signup') }}" class="text-purple-700 fw-semibold">Sign Up</a>
									</p>
								</div>
							</div>
						</div>
