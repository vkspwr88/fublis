				...
				<div class="filter-container" id="collapsedFilter">
					<form wire:submit="search">
						<div class="row g-0 mb-4">
							<div class="col">
								<div class="d-grid">
									<input type="radio" class="btn-check btn-filter-check" name="options-outlined" id="publications-outlined" autocomplete="off" checked>
									<label class="btn btn-outline-primary rounded-0 fw-semibold" for="publications-outlined">
										<a href="{{ route('architect.pitch-story.publications') }}" class="text-purple-700">Publications</a>
									</label>
								</div>
							</div>
							<div class="col">
		...
		<div class="modal fade" id="pitchSuccessModal" tabindex="-1" aria-labelledby="pitchSuccessLabel" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-footer justify-content-center border-0">
						<a href="{{ route('architect.pitch-story.index') }}" class="btn btn-primary px-3">
