				...
				<div class="filter-container" id="collapsedFilter">
					<form wire:submit="search">
						<div class="row g-0 mb-4">
							...
							<div class="col">
								<div class="d-grid">
									<input type="radio" class="btn-check btn-filter-check" name="options-outlined" id="journalists-outlined" autocomplete="off">
									<label class="btn btn-outline-primary rounded-0 fw-semibold" for="journalists-outlined">
										<a href="{{ route('architect.pitch-story.journalists') }}" class="text-gray-500">Journalists</a>
									</label>
								</div>
							</div>
							<div class="col">
								<div class="d-grid">
									<input type="radio" class="btn-check btn-filter-check" name="options-outlined" id="calls-outlined" autocomplete="off" checked>
									<label class="btn btn-outline-primary rounded-0 fw-semibold" for="calls-outlined">
										<a href="{{ route('architect.pitch-story.calls') }}" class="text-purple-700">Calls</a>
									</label>
								</div>
							</div>
						</div>
									...
									<div class="row align-items-center pb-3 g-3">
										<div class="col-md-7">
											<div class="row justify-content-center align-items-center text-center text-md-start">
												<p class="col-12 text-dark fs-5 fw-semibold m-0">Mud Houses</p>
												<p class="col-12 text-secondary fs-6 m-0">Deadline: 17th March 2023 </p>
											</div>
										</div>
										<div class="col-md-5">
											...
											<div class="row justify-content-end">
												<div class="col-12">
													<div class="row justify-content-center justify-content-md-start align-items-center">
														<div class="col-auto">
															<img class="rounded-circle img-fluid" alt="..." src="https://via.placeholder.com/45x45" />
														</div>
														<div class="col-auto text-secondary fs-6">
															<p class="fw-semibold m-0 p-0">Rethinking The Future</p>
															<p class="m-0 p-0 small">David Miller</p>
														</div>
													</div>
												</div>
											</div>
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="row align-items-center pb-3 g-3">
										<div class="col-md-7">
											<div class="row justify-content-center align-items-center text-center text-md-start">
												<p class="col-12 text-dark fs-5 fw-semibold m-0">Urban Squares Around the World</p>
												<p class="col-12 text-secondary fs-6 m-0">Deadline: 17th March 2023</p>
											</div>
										</div>
										<div class="col-md-5">
		...
		<div class="modal fade" id="pitchSuccessModal" tabindex="-1" aria-labelledby="pitchSuccessLabel" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-footer justify-content-center border-0">
						<a href="{{ route('architect.pitch-story.calls') }}" class="btn btn-primary px-3">
