		...
		<div class="col-12">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="text-purple-600 breadcrumb-item fublis-breadcrumb-item fs-6 fw-medium" aria-current="page">{{ $architect->user->name }}</li>
				</ol>
			</nav>
		</div>
	</div>
	...
	<div class="row g-4 justify-content-end align-items-end">
		<div class="col">
			<div class="d-flex justify-content-start">
				<h2 class="m-0 text-dark fs-3 fw-semibold">Your Profile</h2>
			</div>
		</div>
		<div class="col-auto">
